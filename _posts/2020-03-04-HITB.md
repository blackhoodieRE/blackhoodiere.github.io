...
We'll have two classes: one focusing on Windows kernel development, brought to you by [Yarden Shafir] (https://twitter.com/yarden_shafir) and one focusing on Linux binary exploitation, hosted by [Valentine Mairet] (https://twitter.com/vm00z). As is our habit, this BlackHoodie bootcamp will be women-only (as described below), free to attend, lots of fun, and really challenging.
